...
pref("app.update.url.manual", "http://cyberfox.8pecxstudios.com/cyberfox-amd-version-x64"); 
pref("app.update.url.details", "http://cyberfox.8pecxstudios.com/cyberfox-amd-version-x64");
#else
pref("app.update.url.manual", "http://cyberfox.8pecxstudios.com/cyberfox-amd-version-x86"); 
pref("app.update.url.details", "http://cyberfox.8pecxstudios.com/cyberfox-amd-version-x86");
#endif

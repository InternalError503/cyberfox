...
# Copy latest build
wget -O $Dir/tmp_kch/kcyberfoxhelper-$VERSION/kcyberfoxhelper https://github.com/hawkeye116477/kcyberfoxhelper/releases/download/v${VERSION}/kcyberfoxhelper
wget -O $Dir/tmp_kch/kcyberfoxhelper-$VERSION/kcyberfoxhelper.notifyrc https://github.com/hawkeye116477/kcyberfoxhelper/raw/master/kcyberfoxhelper.notifyrc
...
chmod 777 $Dir/tmp_kch/kcyberfoxhelper-$VERSION/kcyberfoxhelper

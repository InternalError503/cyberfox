...
rm -rf $Dir/tmp/cyberfox-$VERSION/cyberfox/SHA512SUMS.chk #Sums will be generated by debhelper, so this is not needed 
...
if [ -f "$Dir/deb_ppa/cyberfox_${VERSION}_amd64.deb" ]; then
	mkdir $Dir/debs

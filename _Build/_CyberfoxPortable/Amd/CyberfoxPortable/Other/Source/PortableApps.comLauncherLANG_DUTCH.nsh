...
LangString LauncherErrorWinXP ${LANG_DUTCH} "Windows XP is not supported by this application!, Compatible operating system is (Windows 7 or Higher)"
LangString LauncherErrorWinVista ${LANG_DUTCH} "Warning: Windows Vista is no longer supported, But can still run on this platform, Press OK to continue!" 
